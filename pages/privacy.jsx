export default function Privacy() {
    return (
        <div className='py-4 px-10 w-full max-w-5xl mx-auto justify-center'>
            <div className="">
                <h1 className="text-green">Datenschutz</h1>
                ...
                <h2>2. Allgemeine Hinweise und Pflicht&not;informationen</h2>
                <h3>Datenschutz</h3>
                ...
                <p>TUNAP GmbH &amp; Co. KG</p>
                <p>B&uuml;rgermeister-Seidl-Str. 2</p>
                <p>82515 Wolfratshausen</p>
                <p>Telefon: +49 (0) 8171 16 00 0</p>
                <p>E-Mail: info@tunap.com</p>
                ...
                <h3>Datenschutz&not;beauftragter</h3>
                <p>Wir haben f&uuml;r unser Unternehmen einen Datenschutzbeauftragten bestellt.</p>
                <p>STARHEAD GmbH</p>
                <p>Telefon: +49 (0) 8171 42 88 55 0</p>
                <p>E-Mail: datenschutz@starhead.de</p>
                ...
                <p>&bull;&nbsp; &nbsp;&nbsp;Wenn die Verarbeitung Ihrer personenbezogenen Daten unrechtm&auml;&szlig;ig geschah/geschieht, k&ouml;nnen Sie statt der L&ouml;schung die Einschr&auml;nkung der Datenverarbeitung verlangen.</p>
